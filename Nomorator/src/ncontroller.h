...
class Controller : public QObject {
  ...
  QFont m_font;
  Q_PROPERTY(
      QSizeF pageSize READ pageSize WRITE setPageSize NOTIFY pageSizeChanged)
  Q_PROPERTY(QSizeF dupOffset READ dupOffset WRITE setDupOffset NOTIFY
                 dupOffsetChanged)
  Q_PROPERTY(
      QPointF startPos READ startPos WRITE setStartPos NOTIFY startPosChanged)
  Q_PROPERTY(int displayPage READ displayPage WRITE setDisplayPage RESET
                 resetDisplayPage NOTIFY displayPageChanged)
